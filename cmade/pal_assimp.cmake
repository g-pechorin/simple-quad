###	Peter LaValle
###	pal_assimp.cmake
###		Scrapes some version of ASSIMP and puts it in your build
###
###	License:
...
##
# Add the assimp stuff
	scrape_archive(assimp c3e6dc31bec6907d2739e7145e80e838 https://github.com/g-pechorin/assimp/archive/3dab9132bbade8b8523216b7259a512836de707c.zip)

	add_scraped_directories(assimp ${scraped_archive_assimp})
	
	##
	# TODO : add a command to process an asset into a file ... or something

##
# group the assimp stuff
	group_target(assimp			"OpenASSIMP")
	group_target(assimp_cmd		"OpenASSIMP")
	group_target(assimp_viewer	"OpenASSIMP")
	group_target(zlibstatic		"OpenASSIMP")
	group_target(unit			"OpenASSIMP")
	group_target(uninstall		"OpenASSIMP")
