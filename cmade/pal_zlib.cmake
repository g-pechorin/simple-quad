...
##
# Add the zlib stuff
	scrape_archive(zlib 6407ca87c799f441536a044d65bd5745 https://github.com/madler/zlib/archive/50893291621658f355bc5b4d450a8d06a563053d.zip)
	
	add_subdirectory(${PAL_DUMP_CACHE}/pal-rat/zlib/zlib-50893291621658f355bc5b4d450a8d06a563053d zlib)
	include_directories(${PAL_DUMP_CACHE}/pal-rat/zlib/zlib-50893291621658f355bc5b4d450a8d06a563053d)

##
# Group the zlib stuff
	group_target(example "zlib")
	group_target(minigzip "zlib")
	group_target(zlib "zlib")
	group_target(zlibstatic "zlib")
